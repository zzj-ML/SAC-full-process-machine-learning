...
mlpmodel = MLPRegressor(random_state=42)

grid_search = GridSearchCV(estimator=mlpmodel, param_grid=param_grid, scoring='neg_root_mean_squared_error', cv=5, n_jobs=-1, verbose=2)
